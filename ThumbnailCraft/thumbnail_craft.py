...
# TODO iconファイルの置き場所を指定できるように
# TODO common.ymlの置き場所を指定できるように
# TODO ssgen eyecatch all で一括変換
# TODO common_ymlが存在しない場合にエラーを出す
...
class ThumbnailCraft:
    ...
    def __overlay_icon(self):
        if self.presets.icon_path is not None:
            ...
            self.img = overlay_icon(self.img, p, self.presets.icon_scale, self.presets.icon_alpha, self.presets.icon_y)
